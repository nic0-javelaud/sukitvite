...
<script lang="ts">
    ...
    export let show_menu:boolean = false;
    export let show_dropdown:boolean = false;
...
<div>
    ...
    <div class="relative z-50 lg:hidden" role="dialog" aria-modal="true">
      ...
      -->
        <Transition 
            ...
            leaveTo="opacity-0"
        >
            <div class="fixed inset-0 bg-gray-900/80" on:click={ () => show_menu = !show_menu }></div>
        </Transition>
                ...
                <div class="relative mr-16 flex w-full max-w-xs flex-1">    
                    ...
                    >
                        <div class="absolute left-full top-0 flex w-16 justify-center pt-5">
                            <button type="button" on:click={ () => show_menu = !show_menu } class="-m-2.5 p-2.5">
                        ...
                        <nav class="flex flex-1 flex-col">
                            ...
                            <li>
                                ...
                                <li>
                                    ...
                                    <a href="/private/page1" on:click={ () => show_menu = !show_menu } class="bg-gray-50 text-indigo-600 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                ...
                                <li>
                                    <a href="/private/page2" on:click={ () => show_menu = !show_menu } class="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
          ...
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
              <ul role="list" class="-mx-2 space-y-1">
                <li>
                  <!-- Current: "bg-gray-50 text-indigo-600", Default: "text-gray-700 hover:text-indigo-600 hover:bg-gray-50" -->
                  <a href="/private/page1" class="bg-gray-50 text-indigo-600 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    <svg class="h-6 w-6 shrink-0 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>
                    Page 1
                ...
                <li>
                  <a href="/private/page2" class="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    <svg class="h-6 w-6 shrink-0 text-gray-400 group-hover:text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                    </svg>
                    Page 2
    ...
    <div class="lg:pl-72">
      <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
        <button type="button" on:click={ () => show_menu = !show_menu } class="-m-2.5 p-2.5 text-gray-700 lg:hidden">
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <!-- Profile dropdown -->
            <div class="relative">
              <button type="button" on:click={ () => show_dropdown = !show_dropdown } class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                <span class="sr-only">Open user menu</span>
                <img class="h-8 w-8 rounded-full bg-gray-50" src="/img/avatar_female.jpg" alt="">
                <span class="hidden lg:flex lg:items-center">
                  <span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">User</span>
      ...
      <main class="py-10">
        <div class="px-4 sm:px-6 lg:px-8">
          <!-- Your content -->
            {#key data.url}
                <div out:fade={{duration: 150, easing: cubicOut}} in:fade={{duration: 150, delay: 150, easing: cubicIn}}>
                    <slot />
                </div>
            {/key}
        </div>
